...
EXP_Q=dmamba_hero
for seed in 231 312; do python train_atari.py --game 'Hero' --data_dir_prefix $DATA_DIR --context_length 50 --token_mixer 'mamba' --output $OUT_DIR --experiment $EXP_Q --seed $seed; done
